...
import 'single_pointer_scrollable.dart';
...
/// or pop-up menu. In that case, you might pair the [SinglePointerSingleChildScrollView]
/// with a [ListBody] child.
///
/// When you have a list of children and do not require cross-axis
/// shrink-wrapping behavior, for example a scrolling list that is always the
/// width of the screen, consider [ListView], which is vastly more efficient
/// than a [SinglePointerSingleChildScrollView] containing a [ListBody] or [Column] with
/// many children.
///
/// ## Sample code: Using [SinglePointerSingleChildScrollView] with a [Column]
///
...
/// make sense to wrap the layout in a [SinglePointerSingleChildScrollView].
///
/// Simply doing so, however, usually results in a conflict between the [Column],
/// which typically tries to grow as big as it can, and the [SinglePointerSingleChildScrollView],
...
/// content beyond the dimensions of the screen, then [SinglePointerSingleChildScrollView]
...
/// the constraints that the [SinglePointerSingleChildScrollView] sees, since viewports
...
///  * [SinglePointerScrollable], which handles arbitrary scrolling effects.
class SinglePointerSingleChildScrollView extends StatelessWidget {
  /// Creates a box in which a single widget can be scrolled.
  const SinglePointerSingleChildScrollView({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    Widget scrollable = SinglePointerScrollable(
