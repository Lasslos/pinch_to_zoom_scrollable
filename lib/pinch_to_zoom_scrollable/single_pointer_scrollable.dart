...
// ignore_for_file: prefer_asserts_with_message, always_put_required_named_parameters_first, unnecessary_null_comparison
...
import 'single_pointer_drag_recognizer.dart';

/// Signature used by [SinglePointerScrollable] to build the viewport through which the
/// scrollable content is displayed.
typedef ViewportBuilder = Widget Function(BuildContext context, ViewportOffset position);

/// A widget that scrolls.
///
/// [SinglePointerScrollable] implements the interaction model for a scrollable widget,
/// including gesture recognition, but does not have an opinion about how the
/// viewport, which actually displays the children, is constructed.
///
/// It's rare to construct a [SinglePointerScrollable] directly. Instead, consider [ListView]
/// or [GridView], which combine scrolling, viewporting, and a layout model. To
/// combine layout models (or to use a custom layout mode), consider using
/// [CustomScrollView].
///
/// The static [SinglePointerScrollable.of] and [SinglePointerScrollable.ensureVisible] functions are
/// often used to interact with the [SinglePointerScrollable] widget inside a [ListView] or
/// a [GridView].
///
/// To further customize scrolling behavior with a [SinglePointerScrollable]:
///
...
///    that keeps the same page visible when the [SinglePointerScrollable] resizes.
///
/// See also:
///
...
class SinglePointerScrollable extends StatefulWidget {
  /// Creates a widget that scrolls.
  ///
  /// The [axisDirection] and [viewportBuilder] arguments must not be null.
  const SinglePointerScrollable({
    super.key,
  ...
  /// [ScrollAction].
  ///
  /// If not supplied, the [SinglePointerScrollable] will scroll a default amount when a
  ...
  /// Whether the scroll actions introduced by this [SinglePointerScrollable] are exposed
  ...
  /// clipping of the [SinglePointerScrollable]. This reflects the same [Clip] that is provided
  ...
  @override
  SinglePointerScrollableState createState() => SinglePointerScrollableState();
  ...
  ///
  /// ```dart
  /// SinglePointerScrollableState scrollable = SinglePointerScrollable.of(context);
  /// ```
  ///
  /// Calling this method will create a dependency on the closest [SinglePointerScrollable]
  /// in the [context], if there is one.
  static SinglePointerScrollableState? of(BuildContext context) {
    final _SinglePointerScrollableScope? widget = context.dependOnInheritedWidgetOfExactType<_SinglePointerScrollableScope>();
  ...
  ///
  /// The heuristic used is determined by the [physics] of this [SinglePointerScrollable]
  ...
  ///
  /// If there is no [SinglePointerScrollable] in the widget tree above the [context], this
  /// method returns false.
  static bool recommendDeferredLoadingForContext(BuildContext context) {
    final _SinglePointerScrollableScope? widget = context.getElementForInheritedWidgetOfExactType<_SinglePointerScrollableScope>()?.widget as _SinglePointerScrollableScope?;
    if (widget == null) {
      return false;
    }
  ...
  static Future<void> ensureVisible(
    ...
    while (scrollable != null) {
      ...
      scrollable = SinglePointerScrollable.of(context);
    }
...
// Enable SinglePointerScrollable.of() to work as if SinglePointerScrollableState was an inherited widget.
// SinglePointerScrollableState.build() always rebuilds its _SinglePointerScrollableScope.
class _SinglePointerScrollableScope extends InheritedWidget {
  const _SinglePointerScrollableScope({
  ...
  final SinglePointerScrollableState scrollable;
  final ScrollPosition position;

  @override
  bool updateShouldNotify(_SinglePointerScrollableScope old) {
    return position != old.position;
  }
}

/// State object for a [SinglePointerScrollable] widget.
///
/// To manipulate a [SinglePointerScrollable] widget's scroll position, use the object
/// obtained from the [position] property.
///
/// To be informed of when a [SinglePointerScrollable] widget is scrolling, use a
/// [NotificationListener] to listen for [ScrollNotification] notifications.
///
/// This class is not intended to be subclassed. To specialize the behavior of a
/// [SinglePointerScrollable], provide it with a [ScrollPhysics].
class SinglePointerScrollableState extends State<SinglePointerScrollable> with TickerProviderStateMixin, RestorationMixin
    implements ScrollContext {
  /// The manager for this [SinglePointerScrollable] widget's viewport position.
  ///
  /// To control what kind of [ScrollPosition] is created for a [SinglePointerScrollable],
  ...
  bool _shouldUpdatePosition(SinglePointerScrollable oldWidget) {
  ...
  @override
  void didUpdateWidget(SinglePointerScrollable oldWidget) {
      ...
      switch (widget.axis) {
        case Axis.vertical:
          _gestureRecognizers = <Type, GestureRecognizerFactory>{
            SinglePointerVerticalDragGestureRecognizer: GestureRecognizerFactoryWithHandlers<SinglePointerVerticalDragGestureRecognizer>(
                  () => SinglePointerVerticalDragGestureRecognizer(supportedDevices: _configuration.dragDevices),
                  (SinglePointerVerticalDragGestureRecognizer instance) {
                instance
        ...
        case Axis.horizontal:
          _gestureRecognizers = <Type, GestureRecognizerFactory>{
            SinglePointerHorizontalDragGestureRecognizer: GestureRecognizerFactoryWithHandlers<SinglePointerHorizontalDragGestureRecognizer>(
                  () => SinglePointerHorizontalDragGestureRecognizer(supportedDevices: _configuration.dragDevices),
                  (SinglePointerHorizontalDragGestureRecognizer instance) {
                instance
                  ..onDown = _handleDragDown
                  ..onStart = _handleDragStart
                  ..onUpdate = _handleDragUpdate
  ...
  Widget build(BuildContext context) {
    assert(_position != null);
    // _SinglePointerScrollableScope must be placed above the BuildContext returned by notificationContext
    // so that we can get this SinglePointerScrollableState by doing the following:
    //
    // ScrollNotification notification;
    // SinglePointerScrollable.of(notification.context)
    //
    // Since notificationContext is pointing to _gestureDetectorKey.context, _SinglePointerScrollableScope
    // must be placed above the widget using it: RawGestureDetector
    Widget result = _SinglePointerScrollableScope(
      scrollable: this,
      position: position,
    ...
    if (!widget.excludeFromSemantics) {
      result = NotificationListener<ScrollMetricsNotification>(
          ...
          child: _SinglePointerScrollSemantics(
    ...
    if (registrar != null) {
      result = _SinglePointerScrollableSelectionHandler(
        state: this,
        position: position,
        registrar: registrar,
        child: result,
...
class _SinglePointerScrollableSelectionHandler extends StatefulWidget {
  const _SinglePointerScrollableSelectionHandler({
    required this.state,
    required this.position,
  ...
  final SinglePointerScrollableState state;
  final ScrollPosition position;
  final Widget child;
  final SelectionRegistrar registrar;

  @override
  _SinglePointerScrollableSelectionHandlerState createState() => _SinglePointerScrollableSelectionHandlerState();
}

class _SinglePointerScrollableSelectionHandlerState extends State<_SinglePointerScrollableSelectionHandler> {
  late _SinglePointerScrollableSelectionContainerDelegate _selectionDelegate;

  @override
  void initState() {
    super.initState();
    _selectionDelegate = _SinglePointerScrollableSelectionContainerDelegate(
      state: widget.state,
  ...
  @override
  void didUpdateWidget(_SinglePointerScrollableSelectionHandler oldWidget) {
    super.didUpdateWidget(oldWidget);
...
class SinglePointerEdgeDraggingAutoScroller {
  /// Creates a auto scroller that scrolls the [scrollable].
  SinglePointerEdgeDraggingAutoScroller(this.scrollable, {this.onScrollViewScrolled, this.velocityScalar = _kDefaultAutoScrollVelocityScalar});

  // An eyeballed value for a smooth scrolling experience.
  static const double _kDefaultAutoScrollVelocityScalar = 7;

  /// The [SinglePointerScrollable] this auto scroller is scrolling.
  final SinglePointerScrollableState scrollable;
...
/// selectable.
class _SinglePointerScrollableSelectionContainerDelegate extends MultiSelectableSelectionContainerDelegate {
  _SinglePointerScrollableSelectionContainerDelegate({
    required this.state,
    required ScrollPosition position,
  }) : _position = position,
        _autoScroller = SinglePointerEdgeDraggingAutoScroller(state, velocityScalar: _kDefaultSelectToScrollVelocityScalar) {
  ...
  final SinglePointerScrollableState state;
  final SinglePointerEdgeDraggingAutoScroller _autoScroller;
...
Offset _getDeltaToScrollOrigin(SinglePointerScrollableState scrollableState) {
...
/// With [_SinglePointerScrollSemantics] certain child [SemanticsNode]s can be
...
/// two semantics nodes will be used to represent the [SinglePointerScrollable]: The outer
/// node will contain all children, that are excluded from scrolling. The inner
/// node, which is annotated with the scrolling actions, will house the
/// scrollable children.
class _SinglePointerScrollSemantics extends SingleChildRenderObjectWidget {
  const _SinglePointerScrollSemantics({
    super.key,
    required this.position,
  ...
  @override
  _SinglePointerRenderScrollSemantics createRenderObject(BuildContext context) {
    return _SinglePointerRenderScrollSemantics(
      position: position,
  ...
  @override
  void updateRenderObject(BuildContext context, _SinglePointerRenderScrollSemantics renderObject) {
    renderObject
      ..allowImplicitScrolling = allowImplicitScrolling
      ..position = position
      ..semanticChildCount = semanticChildCount;
...
class _SinglePointerRenderScrollSemantics extends RenderProxyBox {
  _SinglePointerRenderScrollSemantics({
    required ScrollPosition position,
...
/// An [Action] that scrolls the [SinglePointerScrollable] that encloses the current
/// [primaryFocus] by the amount configured in the [ScrollIntent] given to it.
///
/// If a SinglePointerScrollable cannot be found above the current [primaryFocus], the
/// [PrimaryScrollController] will be considered for default handling of
/// [ScrollAction]s.
///
/// If [SinglePointerScrollable.incrementCalculator] is null for the scrollable, the default
...
class ScrollAction extends Action<ScrollIntent> {
  ...
  bool isEnabled(ScrollIntent intent) {
    ...
    if (contextIsValid) {
      ...
      if (SinglePointerScrollable.of(focus.context!) != null) {
        return true;
      }
  ...
  double _calculateScrollIncrement(SinglePointerScrollableState state, { ScrollIncrementType type = ScrollIncrementType.line }) {
    assert(type != null);
  ...
  double _getIncrement(SinglePointerScrollableState state, ScrollIntent intent) {
  ...
  void invoke(ScrollIntent intent) {
    SinglePointerScrollableState? state = SinglePointerScrollable.of(primaryFocus!.context!);
    if (state == null) {
      ...
      if (primaryScrollController!.position.context.notificationContext == null
          && SinglePointerScrollable.of(primaryScrollController.position.context.notificationContext!) == null) {
        return;
      }
      state = SinglePointerScrollable.of(primaryScrollController.position.context.notificationContext!);
    }
    assert(state != null, '$ScrollAction was invoked on a context that has no scrollable parent');
    assert(state!.position.hasPixels, 'SinglePointerScrollable must be laid out before it can be scrolled via a ScrollAction');
    assert(state!.position.viewportDimension != null);
    assert(state!.position.maxScrollExtent != null);
    assert(state!.position.minScrollExtent != null);
