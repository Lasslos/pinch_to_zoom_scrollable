// ignore_for_file: prefer_asserts_with_message, unnecessary_null_comparison, always_put_required_named_parameters_first
...
///
/// [SinglePointerDragGestureRecognizer] is not intended to be used directly. Instead,
/// consider using one of its subclasses to recognize specific types for drag
/// gestures.
///
/// [SinglePointerDragGestureRecognizer] competes on pointer events of [kPrimaryButton]
/// only when it has at least one non-null callback. If it has no callbacks, it
/// is a no-op.
///
/// See also:
///
///  * [SinglePointerHorizontalDragGestureRecognizer], for left and right drags.
///  * [SinglePointerVerticalDragGestureRecognizer], for up and down drags.
///  * [PanGestureRecognizer], for drags that are not locked to a single axis.
abstract class SinglePointerDragGestureRecognizer extends OneSequenceGestureRecognizer {
  /// Initialize the object.
  ///
  /// [dragStartBehavior] must not be null.
  ///
  /// {@macro flutter.gestures.GestureRecognizer.supportedDevices}
  SinglePointerDragGestureRecognizer({
    super.debugOwner,
    @Deprecated(
  ...
  /// ## Example:
  ///
  /// A [SinglePointerHorizontalDragGestureRecognizer] and a [SinglePointerVerticalDragGestureRecognizer]
  ...
  /// the [SinglePointerHorizontalDragGestureRecognizer] wins the arena. With
  ...
  ///
  /// To estimate the velocity of a gesture, [SinglePointerDragGestureRecognizer] calls
...
/// See also:
///
///  * [SinglePointerHorizontalDragGestureRecognizer], for a similar recognizer but for
///    horizontal movement.
///  * [MultiDragGestureRecognizer], for a family of gesture recognizers that
///    track each touch point independently.
class SinglePointerVerticalDragGestureRecognizer extends SinglePointerDragGestureRecognizer {
  /// Create a gesture recognizer for interactions in the vertical axis.
  ///
  /// {@macro flutter.gestures.GestureRecognizer.supportedDevices}
  SinglePointerVerticalDragGestureRecognizer({
    super.debugOwner,
    @Deprecated(
      'Migrate to supportedDevices. '
          'This feature was deprecated after v2.3.0-1.0.pre.',
...
/// See also:
///
///  * [SinglePointerVerticalDragGestureRecognizer], for a similar recognizer but for
///    vertical movement.
///  * [MultiDragGestureRecognizer], for a family of gesture recognizers that
///    track each touch point independently.
class SinglePointerHorizontalDragGestureRecognizer extends SinglePointerDragGestureRecognizer {
  /// Create a gesture recognizer for interactions in the horizontal axis.
  ///
  /// {@macro flutter.gestures.GestureRecognizer.supportedDevices}
  SinglePointerHorizontalDragGestureRecognizer({
    super.debugOwner,
    @Deprecated(
      'Migrate to supportedDevices. '
          'This feature was deprecated after v2.3.0-1.0.pre.',
